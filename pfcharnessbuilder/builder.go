...
func main() {
	...
	set := &coinknife.Settings{
		PathToInputRepo:        `D:\PICFIGHT\src\github.com\jfixby\dcrharness`,
		PathToOutputRepo:       `D:\PICFIGHT\src\github.com\picfight\pfcharness`,
